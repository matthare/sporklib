...
spork_fpid_list.extend(spork_cvr_fpid_list)
...
for item in spork_set:
    ...
    if item in spork_cvr_dict:
        _ = spork_dict.setdefault(item,spork_cvr_dict[item])
    elif item in spork_epub_dict:
...
print "------- Cover Summary --------"
print_summary(query_fpid_list,spork_cvr_fpid_list,query_dict,spork_cvr_dict)
